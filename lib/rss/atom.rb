...
module RSS
  ...
  module Atom
    ...
    #
    # The Person Construct has a Name, Uri, and Email child elements
    ...
    # Element used to describe an Atom date and time in the W3C format
    #
    # Examples:
    ...
    class Feed < RSS::Element
      ...
      # returns true if there are any authors for the feed
      # or any of the Entry child elements have an author
      def have_author?
      ...
      # Atom Rights element
      #
      # Text construct that conveys information about rights held in and over an Entry or Feed
      ...
      #
      # Text construct that conveys a description or subtitle for a Feed
      ...
      # Atom Title element
      #
      # Text construct that conveys a description or title for a feed or Entry
      ...
      #
      # Date construct indicating the most recent time when an Entry or Feed was modified
      ...
      # Defines an Atom Entry element that is a child of an Atom Feed
      #
      ...
      class Entry < RSS::Element
        ...
        # * any of the authors are not empty
        # * if *check_parent* is true and the parent has an author
     ...
     # Defines an top-level Atom Entry element
      #
    class Entry < RSS::Element
      include RootElementMixin
      include CommonModel
      ...
      # Returns true if any of the authors is nor empty or there is a source attribute that
      # has an author
      def have_author?
        authors.any? {|author| !author.to_s.empty?} or
          (source and source.have_author?)
